...
const Commentvideocomp = ({ username, profileImage, createdAt, comment, id,tweetid }) => {
  const [openPopup, setopenPopup] = useState(false);

  const deleteComment = async () => {
    try {
      const postsdata = await fetch(
        `${process.env.REACT_APP_LOCALHOST_KEY}/api/addpost/deletevideocomment`,
        {
          method: "POST",
          body: JSON.stringify({
...
export default Commentvideocomp;
